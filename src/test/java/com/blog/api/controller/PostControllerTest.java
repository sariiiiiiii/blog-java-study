...
class PostControllerTest {
    ...
    public void post() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/test")
                        ...
                        .content("{\"title\": \"타이틀입니다.\", \"content\": \"콘텐츠 입니다.\"}")
                )
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void test() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/test")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"title\":  \"타이틀입니다\", \"content\" : \"콘텐츠입니다.\"}")
                )
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
        ...
        Assertions.assertEquals("타이틀입니다", post.getTitle());
        Assertions.assertEquals("콘텐츠입니다.", post.getContent());
